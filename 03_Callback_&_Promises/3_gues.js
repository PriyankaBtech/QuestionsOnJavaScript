...
function ageInDays(personalObject, callback) {
    const fullName = `${personalObject.firstName} ${personalObject.lastName}`
    const ageInDays = personalObject.age * 365
...
const result = ageInDays(person, logResult)

console.log(result) // The person full name is Priyanka Kaushal and their age in days is 8395